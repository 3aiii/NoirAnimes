...
const Navbar = () => {
    ...
    return (
        <div className=' sticky top-0 bg-black py-2 z-30 w-full'>
            <div className='flex justify-between gap-10 items-center md:py-4 md:px-24 py-[8px] px-[16px]'>
                <Link 
                    to={'/'} 
                    className={ `${default_navbar} 
                        tracking-widest md:text-[44px] text-[24px] cursor-pointer
                ...
                <div className='flex gap-6'>
                    <div className='bg-white md:flex rounded-md hidden'>
                        <input
                            type='text'
                            name='search'
                            className=' px-2 rounded-md w-56 text-lg placeholder:text-lg placeholder: '
                            ...
                            <div className='relative text-white flex gap-2 items-center'>
                                <div className='md:block hidden'>
                                    <img
                                        ...
                                        alt='avatar-user-img'
                                        className=' object-cover w-[40px] h-[40px] rounded-md cursor-pointer hover:scale-125 duration-150 '
                                            ...
                                            <ul className='flex flex-col '>
                                                {
                                                    navbar_list.map((data)=>(
                                                        <li 
                                                            className={ `relative cursor-pointer md:hidden show text-md py-[4px]` }
                                                            key={ data.id }
                                                        >
                                                            <Link 
                                                                to={`/${data.name}`}
